...
inputQuery.setLowerBound(2, 0)  #ReLU
inputQuery.setUpperBound(2, large)  #ReLU
inputQuery.setLowerBound(3, -large)
inputQuery.setUpperBound(3, large)
inputQuery.setLowerBound(4, 0) #ReLU
inputQuery.setUpperBound(4, large) #ReLU
...
equation1.addAddend(1, 0) #(multiplier to the variable, variable index) --> 1*x0
equation1.addAddend(-1, 1) # -1*x1
equation1.setScalar(0) # = 0
inputQuery.addEquation(equation1)  # Summing above three lines: {1*x0 -1*x1 = 0}
...
MarabouCore.addReluConstraint(inputQuery, 1, 2)  #Adding ReLU constraints between x1b and x1f
MarabouCore.addReluConstraint(inputQuery, 3, 4)  #Adding ReLU constraints between x2b and x2f
