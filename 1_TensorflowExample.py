...
network.setLowerBound(inputVars[0],-10.0)	# -10 < x0 < 10
network.setUpperBound(inputVars[0], 10.0)	
network.setLowerBound(inputVars[1],-10.0)	# -10 < x1 < 10
network.setUpperBound(inputVars[1], 10.0)

# %%
# Set output bounds on the second output variable
network.setLowerBound(outputVars[1], 100.0)	# 190 < y1 < 200
network.setUpperBound(outputVars[1], 155.0)
